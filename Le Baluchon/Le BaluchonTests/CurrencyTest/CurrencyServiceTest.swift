...
final class ClassCurrencyTests: XCTestCase {
    // MARK: - Properties
    ...
    func testRequestMethod_WhenErrorIsGiven_ThenShouldReturnAResponseError() {
    ...
    func testRequestMethod_WhenErrorIsGiven_ThenShouldReturnADataError() {
